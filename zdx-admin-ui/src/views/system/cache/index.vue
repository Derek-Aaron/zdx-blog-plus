...
const getList = () => {
    const downloadLoadingInstance = ElLoading.service({ text: "正在加载缓存监控数据，请稍候！", background: "rgba(0, 0, 0, 0.7)", })
    baseApi('system', 'cache').then(res => {
                        ...
                        <table cellspacing="0" style="width: 100%">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="el-table__cell is-leaf">
                                        <div class="cell" v-if="cache.info">{{ cache.info.redis_mode == "standalone" ? "单机"
                                            : "集群" }}</div>
                                    </td>
                                    <td class="el-table__cell is-leaf">

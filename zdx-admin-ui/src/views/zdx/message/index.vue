	...
	<div class="app-container">
		...
		<el-form :model="queryParams.params" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
			<el-form-item label="用户昵称" prop="name">
				<el-input v-model="queryParams.params.nickname" placeholder="请输入用户昵称" clearable
						  style="width: 240px"
		...
		<el-row :gutter="10" class="mb8">
			<el-col :span="1.5">
				<el-button type="success" plain icon="Edit" :disabled="!ids.length > 0" @click="handleThrough">
					批量通过
				</el-button>
			</el-col>
			<el-col :span="1.5">
		...
		<el-table v-loading="loading" :data="messageList" @selection-change="handleSelectionChange">
			...
			<el-table-column label="审核" align="center" key="isCheck" prop="isCheck" show-overflow-tooltip>
				<template #default="scope">
					<el-switch v-model="scope.row.isCheck" class="ml-2" :active-value="true" :inactive-value="false"

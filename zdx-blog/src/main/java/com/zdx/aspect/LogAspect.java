...
public class LogAspect {
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        event.setAttribute(EventObject.Attribute.REQUEST, ServletUtils.getRequest());
        event.setAttribute(EventObject.Attribute.STOP_WATCH, stopWatch);
    ...
    public void doAfterThrowing(JoinPoint point, Throwable e) {
        ...
        event.setAttribute(EventObject.Attribute.USER_SESSION, UserSessionFactory.userDetails());
        event.setAttribute(EventObject.Attribute.REQUEST, ServletUtils.getRequest());
        event.setAttribute(EventObject.Attribute.THROWABLE, e);
        applicationContext.publishEvent(event);
    }
}

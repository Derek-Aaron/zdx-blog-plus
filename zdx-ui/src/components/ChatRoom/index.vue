...
const websocket = ref();
const timeout = ref();
const serverTimeout = ref();
const isMy = computed(() => (chat) => chat.ipAddress === ipAddress.value || (chat.userId !== undefined && chat.userId === user.id));
